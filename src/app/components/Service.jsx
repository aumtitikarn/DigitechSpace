  ...
  return (
    <main className='flex flex-col items-center justify-center p-4 md:flex-row'>
      <div className='flex flex-col w-full max-w-3xl'>
        ...
        <button onClick={handleClick} className='flex flex-row justify-between w-full p-4 mt-4 bg-white border border-gray-300 rounded'>
        ...
        <button onClick={handleClick1} className='flex flex-row justify-between w-full p-4 mt-4 bg-white border border-gray-300 rounded'>
          <div className='flex flex-col justify-center w-auto h-10'>
            {'How can I contact the seller?'}
          </div>
          <div className='flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full'>
        ...
        <button onClick={handleClick2} className='flex flex-row justify-between w-full p-4 mt-4 bg-white border border-gray-300 rounded'>
          <div className='flex flex-col justify-center w-auto h-10'>
            {'How can I contact the seller?'}
          </div>
          <div className='flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full'>
        ...
        <button onClick={handleClick3} className='flex flex-row justify-between w-full p-4 mt-4 bg-white border border-gray-300 rounded'>
          <div className='flex flex-col justify-center w-auto h-10'>
            {'How can I contact the seller?'}
          </div>
          <div className='flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full'>
        ...
        <div className='flex flex-col justify-center w-full mt-6'>
          ...
          <p className='mt-2 text-lg'>Please contact us. If you have any problems using this website.</p>
