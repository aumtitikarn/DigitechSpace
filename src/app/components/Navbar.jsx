                  ...
                  <>
                    {postData?.imageUrl?.[0] ? (
                      <Image
                        width={200}
                        height={200}
                        src={postData.imageUrl[0].startsWith('http')
                          ? postData.imageUrl[0] // If it's a full URL, use it as is
                          : `/api/editprofile/images/${postData.imageUrl[0]}`} // If it's a file path, prepend the base path
                        alt="Profile"
                        style={{
                          objectFit: "cover",
                          borderRadius: "50%",
