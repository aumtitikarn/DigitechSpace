        ...
        <div className='text-left'>
          ...
          <ul className="list-none mt-3 space-y-2">
            <li className="flex items-center">
              <FaFacebook className="mr-2" /> <span className='text-[16px]'> : DigitechSpace</span>
            </li>
            <li className="flex items-center">
              <FaLine className="mr-2" /> <span className='text-[16px]'> : @DigitechSpace</span>
            </li>
            <li className="flex items-center">
              <MdEmail className="mr-2" /> <a href="mailto:DigitechSpace@gmail.com" className='text-[16px] text-white'>
