  ...
  try {
    ...
    if (typec === 'credit_card') {
      ...
      charge = await omise.charges.create({
        ...
        return_uri: `http://digiproj.sut.ac.th:3001/myproject`,
      });
    ...
    return NextResponse.json({
      authorizeUri: typec === 'credit_card' ? `return_uri: http://digiproj.sut.ac.th:3001/myproject` : charge.authorize_uri,
      status: 'success',
      token: charge.id,
      charge: {
        id: charge.id,
